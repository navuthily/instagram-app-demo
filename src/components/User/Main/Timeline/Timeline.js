...
class Timeline extends Component {
  ...
  addComment(e) {
    e.preventDefault();
    const { contentComment, posts } = this.state;
  ...
  render() {
    ...
    return (
      <div className="main">
        ...
        <div className="post">
          <img className="imagePosted" src={this.props.imagePost} />
        </div>
        <div className="react">
          <div className="emotion">
            <div className="heart">
              <button onClick={this.addHeart}>{a}</button>
              <button>
                <svg
          ...
          <div className="like">
            <p>{this.props.like} lượt thích</p>
          </div>
        ...
        <div className="add-comment">
          <form className="form-comment">
            ...
            />
            <button onClick={this.addComment} key={this.props.key}>
              Đăng
            </button>
          </form>
        </div>
